 ...
 */
export function PluginManagerSection({ t, list, profileList, remove, removeProfile }) {
    ...
    return (_jsxs("div", { className: css.section, "aria-busy": state.status === 'loading', children: [state.status === 'loading' ? _jsx("p", { className: css.status, children: t('loading') }) : null, state.status === 'error' ? (_jsxs("div", { className: css.failure, children: [_jsx("p", { role: "alert", children: t('error') }), _jsx("button", { type: "button", onClick: reload, children: t('retry') })] })) : null, actionError !== null ? _jsx("p", { className: css.failure, role: "alert", children: actionError }) : null, state.status === 'ready' ? (_jsxs("div", { className: css.catalog, children: [_jsxs("div", { className: css.catalogHeading, children: [_jsx("h3", { children: t('catalog') }), _jsx("span", { "data-plugin-count": plugins.length, children: plugins.length })] }), plugins.length === 0 ? _jsx("p", { className: css.status, children: t('empty') }) : null, plugins.length > 0 ? (_jsxs("div", { className: css.table, role: "table", "aria-label": t('catalog'), children: [_jsxs("div", { className: css.rowHeader, role: "row", children: [_jsx("span", { role: "columnheader", children: t('columnName') }), _jsx("span", { role: "columnheader", children: t('columnPlugin') }), _jsx("span", { role: "columnheader", children: t('columnDetail') })] }), plugins.map((plugin) => {
                                const open = expanded === plugin.pluginName;
                                const busy = deleting === plugin.pluginName;
                                return (_jsxs(Fragment, { children: [_jsxs("div", { className: css.row, role: "row", "data-open": open ? 'true' : undefined, children: [_jsx("span", { className: css.cellName, role: "cell", title: plugin.pluginName, children: plugin.displayName }), _jsx("span", { className: css.cellPlugin, role: "cell", children: plugin.pluginName }), _jsx("span", { className: css.cellAction, role: "cell", children: _jsxs("button", { type: "button", className: css.detailButton, "aria-expanded": open, onClick: () => { setExpanded(open ? null : plugin.pluginName); }, children: [t('detail'), _jsx(IconChevronDownOutline14, { className: css.chevron, size: 12, "aria-hidden": "true" })] }) })] }), open ? (_jsxs("div", { className: css.details, role: "row", children: [_jsx("span", { className: css.detailsTitle, role: "cell", children: t('skills') }), plugin.skills.length === 0 ? (_jsx("span", { className: css.detailsEmpty, role: "cell", children: t('noSkills') })) : (_jsx("ul", { className: css.skillList, role: "cell", children: plugin.skills.map(skill => (_jsxs("li", { children: [_jsx("strong", { children: skill.name }), skill.description.length > 0 ? _jsx("span", { children: skill.description }) : null] }, skill.name))) })), _jsx("div", { className: css.detailsDelete, role: "cell", children: _jsxs("button", { type: "button", className: css.detailsDeleteButton, disabled: busy, onClick: () => { setConfirmTarget({ kind: 'managed', name: plugin.pluginName }); }, children: [_jsx(IconTrashOutline16, { size: 14, "aria-hidden": "true" }), t('delete')] }) })] })) : null] }, plugin.pluginName));
                            })] })) : null, _jsxs("div", { className: css.catalog, children: [_jsxs("div", { className: css.catalogHeading, children: [_jsx("h3", { children: format(t('profileCatalog'), { profile: state.profile.profile }) }), _jsx("span", { "data-plugin-count": state.profile.plugins.length, children: state.profile.plugins.length })] }), state.profile.plugins.length === 0 ? _jsx("p", { className: css.status, children: t('profileEmpty') }) : null, state.profile.plugins.length > 0 ? (_jsxs("div", { className: css.table, role: "table", "aria-label": format(t('profileCatalog'), { profile: state.profile.profile }), children: [_jsxs("div", { className: `${css.rowHeader} ${css.rowHeader3}`, role: "row", children: [_jsx("span", { role: "columnheader", children: t('columnName') }), _jsx("span", { role: "columnheader", children: t('columnPlugin') }), _jsx("span", { role: "columnheader", children: t('columnSpec') }), _jsx("span", { role: "columnheader", children: t('columnDetail') })] }), state.profile.plugins.map((plugin) => {
