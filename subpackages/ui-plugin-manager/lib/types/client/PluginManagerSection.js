...
export function PluginManagerSection({ t, list, profileList, remove, removeProfile }) {
    ...
    return (_jsxs("div", { className: css.section, "aria-busy": state.status === 'loading', children: [state.status === 'loading' ? _jsx("p", { className: css.status, children: t('loading') }) : null, state.status === 'error' ? (_jsxs("div", { className: css.failure, children: [_jsx("p", { role: "alert", children: t('error') }), _jsx("button", { type: "button", onClick: reload, children: t('retry') })] })) : null, actionError !== null ? _jsx("p", { className: css.failure, role: "alert", children: actionError }) : null, state.status === 'ready' ? (_jsx("div", { className: css.catalog, children: _jsxs("div", { className: css.catalog, children: [_jsxs("div", { className: css.catalogHeading, children: [_jsx("h3", { children: t('catalog') }), _jsx("span", { "data-plugin-count": state.profile.plugins.length, children: state.profile.plugins.length })] }), state.profile.plugins.length === 0 ? _jsx("p", { className: css.status, children: t('profileEmpty') }) : null, state.profile.plugins.length > 0 ? (_jsxs("div", { className: css.table, role: "table", "aria-label": t('catalog'), children: [_jsxs("div", { className: `${css.rowHeader} ${css.rowHeader3}`, role: "row", children: [_jsx("span", { role: "columnheader", children: t('columnName') }), _jsx("span", { role: "columnheader", children: t('columnPlugin') }), _jsx("span", { role: "columnheader", children: t('columnSpec') }), _jsx("span", { role: "columnheader", children: t('columnDetail') })] }), state.profile.plugins.map((plugin) => {
